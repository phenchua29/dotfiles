# Phen Chua's agent instructions

These are common instructions for Phen Chua's agents across all scenarios.
...
- Never read files that may contain secrets. Ask for permission or guidance if it's a must.
